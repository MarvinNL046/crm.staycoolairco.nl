            ...
            {hours.map((hour) => (
              <div key={hour} className="relative">
                <div className="flex h-[60px] border-b">
                  ...
                  <div 
                    className="flex-1 border-l hover:bg-gray-50 cursor-pointer transition-colors"
            ...
            <div className="absolute inset-0 left-20 pointer-events-none">
              {positionedAppointments.map(({ appointment, column, totalColumns }) => {
                ...
                return (
                  <div
                    key={appointment.id}
                    className="absolute cursor-pointer transition-all hover:z-30 hover:shadow-lg pointer-events-auto"
                    style={{
                      ...style,
                      left: `${left}%`,
                      width: `${width}%`,
